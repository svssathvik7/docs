...
export default function FooterLayout({
    ...
    return (
        ...
        >
            ...
            ></div>
            <div className="footer__links flex flex-col gap-8 md:flex-row w-full py-16 justify-between sm:w-[35rem] md:w-[51rem] lg:w-[67rem] mx-auto">
                <div>{logo}</div>
                {links}
            </div>
            <div
            ...
            ></div>
            <div className="footer__copyright pt-4 mb-14 flex flex-col sm:flex-row gap-4 justify-between w-full sm:w-[35rem] md:w-[51rem] lg:w-[67rem] mx-auto">
