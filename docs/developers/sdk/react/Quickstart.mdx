      ...
      <QueryClientProvider client={new QueryClient()}>
        <GardenProvider // Wraps app with Garden context
          config={{
            ...
            environment: environment.mainnet, // Sets the environment to testnet | mainnet
          }}
        >
          <App />
        </GardenProvider>
...
- Initialize the [secret manager](../../core/SecretManager.mdx) to handle atomic swap secrets securely.  
- Initiate the transaction to complete the swap.
- Track the order [status](../../core/GetOrders.mdx) to monitor progress.
